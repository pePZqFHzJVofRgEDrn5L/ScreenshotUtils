...
{
    [ToolboxItem(true)]
    public partial class ComboBox : PictureBox {
        [Browsable(true)]
        ...
        private ListControl dropDownControl;
        [Browsable(false)]
        public ListControl DropDownControl {
        ...
        protected override void OnPaint(PaintEventArgs pe) {
            ...
            if (isPopup) {
                g.DrawImage(global::ScreenshotUtils.Properties.Resources.arrowlist.Clone(new Rectangle(33, 0, 11, 11), System.Drawing.Imaging.PixelFormat.Format32bppPArgb), new Rectangle(this.Width - 18, 6, 11, 11));
            } else {
                g.DrawImage(global::ScreenshotUtils.Properties.Resources.arrowlist.Clone(new Rectangle(11, 0, 11, 11), System.Drawing.Imaging.PixelFormat.Format32bppPArgb), new Rectangle(this.Width - 18, 6, 11, 11));
            }
