...
namespace ScreenshotUtils.ControlExt
{
    public partial class ImageProcessBox : Control
    {
        ...
        {
            //logger.Info("ImageProcessBox.ImageProcessBox");
            InitializeComponent();
            InitMember();
        ...
        {
            //logger.Info("ImageProcessBox.InitMember");
        ...
        {
            // logger.Info("ImageProcessBox.DeleResource");
            pen.Dispose();
            brush.Dispose();
            if (bmpDark != null)
            {
        ...
        {
            //logger.Info("ImageProcessBox.OnMouseDown");
        ...
        {
            //logger.Info("ImageProcessBox.OnMouseMove");
        ...
        {
            //logger.Info("ImageProcessBox.OnMouseLeave");
            bMouseEnter = false;
            this.Invalidate();
            base.OnMouseLeave(e);
        }
        ...
        {
            //logger.Info("ImageProcessBox.OnMouseUp");
            if (e.Button == MouseButtons.Left)
            {        //如果绘制太小 则视为无效
        ...
        protected virtual void DrawInfo(Graphics g)
        {
            ...
            try
            {
                clr = ((Bitmap)this.baseImage).GetPixel(ptCurrent.X, ptCurrent.Y);
            }
            catch (Exception e)
            {
                // logger.Info(e);
